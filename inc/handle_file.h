...
###########################################*/
    ...
    #define HANDLE_FILE_H
        ...
        int remove_by_cargo(const char *file_name, const char *cargo); // Funcao que remove um registro baseado no campo cargo
        long int insert_bin(const char *file_name, int id, double salario, const char *telefone, const char *nome, const char *cargo); // Funcao que insere um registro novo
